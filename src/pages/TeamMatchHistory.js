...
class MyMatchHistory extends Component {
  ...
  //소속된 팀 이름 구하기
  getMyTeamName = () => {
    const url = "http://localhost:9000/matchplay/team/getteamname?team_num=";

    Axios.get(url + this.state.myteamnum)
      .then((res) => {
        this.setState(
          {
            myteamname: res.data,
        ...
        console.log("내 팀이름===" + this.state.myteamname);
        // this.props.Onlist();
      })
      .catch((err) => {
        console.log(err);
  ...
  getTotalOfMyRes = () => {
    const url = "http://localhost:9000/matchplay/team/totalmyres?member_id=";
    // const url = "http://192.168.0.108:9000/matchplay/team/totalmyres?member_id=";
  ...
  getMyRes = () => {
    const url = "http://localhost:9000/matchplay/team/myres?member_id=";
    // const url = "http://192.168.0.108:9000/matchplay/team/myres?member_id=";
        ...
        <div align="center">
          ...
          >
            <b style={{ fontSize: "20pt" }}>
              {this.state.myteamname.team_name}
            </b>
            팀의 경기 내역
            <select
